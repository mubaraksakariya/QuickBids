...
class Transaction(models.Model):
    ...
    # Optional external transaction ID, can be bid_id for refund and paymen
    transaction_id = models.CharField(max_length=255, null=True, blank=True)
    receiver_wallet = models.ForeignKey(Wallet, on_delete=models.SET_NULL, null=True,
                                        blank=True, related_name='received_transfers')  # For transfers or payments
