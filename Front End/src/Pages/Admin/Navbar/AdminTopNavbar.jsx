...
const AdminTopNavbar = ({ selectedTab, setSearchString }) => {
	...
	return (
		<div className='flex items-center justify-between bg-sectionBgColour2 p-4 border-b border-cardBorderColour'>
			...
			<div className='flex items-center space-x-4'>
				...
				{!showSearch && (
					<input
						type='text'
						placeholder='Search...'
						className='p-2 border border-cardBorderColour rounded bg-sectionBgColour1 text-bodyTextColour'
						onChange={(e) =>
